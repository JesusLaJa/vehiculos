...
public class TestMain {
    ...
    public static void main(String[] args) throws Exception {
        ...
        /**
         * SABER SI YA EXISTE UNA MARCA REGISTRADA
         */
        int nNombre = marcaDAO.getExisteMarca("NISSAN");

        System.out.println("Número de veces que se encontró: " + nNombre);
        ...
        *******************************
         ...
         * ******************
        */
        int nModelo = vehiculoDAO.getExisteModeloConce(0,0,"");

        System.out.println("Número de veces que se encontró: " + nModelo);
